...
public class MapFragment extends Fragment {
    ...
    public static void setUpMapIfNeeded() {
        ...
        if (mMap == null) {
            ...
            mMap = ((SupportMapFragment) OlxActivity.fragmentManager
    ...
    public void onDestroyView() {
        super.onDestroyView();
        if (mMap != null) {
            OlxActivity.fragmentManager.beginTransaction()
                    .remove(OlxActivity.fragmentManager.findFragmentById(R.id.location_map)).commit();
            mMap = null;
        }
    }
}
